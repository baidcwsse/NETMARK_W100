...
extern INT8U rf_flag; //接收中断里使用
extern INT16U itmp; //delay
...
#define FIXED_PACKET_LEN    17//Packet size in fixed size mode
#define REPEAT_CNT          15//0-15, repeat transmit count
#define DATA_SPEED          1 //0:250Kbps, 1:1Mbps, 2:2Mbps
#define INIT_ADDR           0x34,0x43,0x10,0x10,0x01//0XE7,0XE7,0XE7,0XE7,0XE7
...
#define L01_CSN_LOW( )   { RFCSN = 0; }
#define L01_CSN_HIGH( )  { RFCSN = 1; }
#define L01_CE_LOW( )    ;//{ RFCE = 0; } 
#define L01_CE_HIGH( )   ;//{ RFCE = 1; } 
...
/*Send the communication speed of the RF device  0:250Kbps;   1:1Mbps;   2:2Mbps;  other: 1Mbps*/
//void L01_SetSpeed( INT8U speed );

/*Reuse last TX packet*/
//void L01_ReuseLastPacket( void );
